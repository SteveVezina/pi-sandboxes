...
| M8: Agent Loop, Egress, Template Library | F28, F29, F30 | 🔵 In progress — F30 core egress path done (T30.4 Linux-blocked); F29 run state + events + CLI done (agent launch = spec gap); F28 spec written (PROP-006 applied 2026-08-31) |
