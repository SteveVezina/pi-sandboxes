...
| M8: Agent Loop and Egress | F29, F30 | 🔵 In progress — F30 core egress path done (T30.4 L3 isolation Linux-blocked); F29 run state + events + CLI done, agent launch blocked on entrypoint-resolution spec gap |
