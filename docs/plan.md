...
**Current phase:** PROP-008 runtime driver contract (applied 2026-07-14, ADR-005) — F4/T15.2, F3, F5, F6, F10 complete; F9 partially (list/pull/pack done, 2 open gaps); F11 found to be a bigger gap than tracked, downgraded
...
Remaining ⚠️ Needs re-verify features per INDEX: F12, F13, F14, F15(SDKs), F16, F17, F18, F22. F17 (Policy Enforcement) likely shares F11's problem (policy-as-unwired-library) — worth checking next, or ADR-first on egress enforcement before continuing further into network/secrets/policy territory.
