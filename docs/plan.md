...
Open F28: T28.2b snapshot-from-sandbox (runtime hooks, Linux), T28.2c promote (config default_template key), T28.4 GUI. Also: audit-log line per mutating template op (AC-35.11).
