...
| [PROP-006](PROP-006-local-template-library.md) | Add Local Template Library and Lifecycle | ✅ Applied to block spec (2026-08-31) | Added F28 / AC-35: rich template metadata, local fork/snapshot/import/export/history/diff/rollback/promote, and GUI template management | 2026-07-15 |
