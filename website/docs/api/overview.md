...
| GET · POST | `/v1/templates` · `/v1/templates/{name}` · `/v1/templates/fork` · `/v1/templates/validate` · `/v1/templates/diff` · `/v1/templates/{name}/history` · `/v1/templates/{name}/rollback` |
